...
**Verification depth scales with `asvs_level`** (see @D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
