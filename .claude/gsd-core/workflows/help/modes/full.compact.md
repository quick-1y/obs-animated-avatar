...
**`/gsd-capture --note <text>`** — Zero-friction timestamped note to `.planning/notes/` (or `D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/notes/` globally). Subcommands: append (default), list, promote (note → todo). Works without a project.
