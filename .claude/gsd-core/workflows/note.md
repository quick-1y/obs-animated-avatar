...
- **Global scope**: `D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/notes/`)
...
2. Glob `D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/notes/` — works in any directory
