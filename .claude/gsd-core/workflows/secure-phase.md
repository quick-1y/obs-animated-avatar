...
```
Agent(
  prompt="Read D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Users/qu1ck1y/Documents/pyProjects/obs_avatar/.claude/gsd-core/templates/SECURITY.md`
